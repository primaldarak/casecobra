    ...
    return (
      <div className='w-full mt-24 flex justify-center'>
        <div className='flex flex-col items-center gap-2'>
          ...
          <h3 className='font-semibold text-left'>Loading your order...</h3>
  ...
  if (data === false) {
    return (
      <div className='w-full mt-24 flex justify-center'>
        <div className='flex flex-col items-center gap-2'>
          <Loader2 className='h-8 w-8 animate-spin text-zinc-500' />
          <h3 className='font-semibold text-left'>Verifying your payment...</h3>
        ...
        <div className=' mt-10 border-t border-zinc-200'>
          <div className=' mt-10 flex flex-col flex-auto'>
            ...
            <p className='mt-2 text-sm text-zinc-600'>
              ...
              good but also last you for the years to come. We offer 5-year
